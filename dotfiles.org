...
#+BEGIN_SRC conf :noweb-ref user-dirs :tangle stow/xdg/.config/user-dirs.dirs
  ...
  XDG_PUBLICSHARE_DIR="$HOME/Gedeeld"
...
#+BEGIN_SRC conf :tangle stow/jupyter/.local/share/applications/jupyterlab.desktop :noweb yes
  <<desktop-nodisplay>>
  Name=JupyterLab
#+END_SRC
...
*** Fonts
For consistency, configuration must match [[*Fontconfig][Fontconfig]] configuration.
...
* Fontconfig
For a guide on determining the subpixel layout of a monitor, see
[[http://www.lagom.nl/lcd-test/subpixel.php][Subpixel Layout (Lagom)]].

* Qt
Enable qt5ct.

#+BEGIN_SRC conf :tangle stow/qt/.config/environment.d/50-qt.conf
  QT_QPA_PLATFORMTHEME=qt5ct
#+END_SRC

Enable GTK file dialogs.

#+BEGIN_SRC conf :tangle stow/qt/.config/qt5ct/qt5ct.conf
  [Appearance]
  standard_dialogs=gtk3
#+END_SRC

Set fonts. Font values are serialized.

- =general= (variable pitch): Sans Serif, 9 points
- =fixed= (fixed pitch): Monospace, 9 points
...
Disable blink cursor in Markdown and code cells.
